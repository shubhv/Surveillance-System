// view plainprint?
    ...
    {  
     ...
     // pMOG2 = new BackgroundSubtractorMOG2(100, 0.95, false);  
     // pGMG = new BackgroundSubtractorGMG(); 
     // pGMG->setNumFrames(200);
     // pGMG->setDecisionThreshold(0.6); 
     // pGMG = createBackgroundSubtractorGMG(200, 0.6);  
      
     char fileName[100] = "../dataset/sample3.dav"; //Gate1_175_p1.avi"; //mm2.avi"; //";//_p1.avi";  
     ...
     while (true) {     
      ...
      //               frame = Mat::ones(frame.size().width, frame.size().height, CV_8U);
      //           else 
      //               break;
      //       } 
      ...
      cout<<"image type = "<<frame.type()<<endl;
        // printf("width = %d, height = %d", frame.size().width, frame.size().height);
...
// 라벨: Background subtraction, OpenCV
